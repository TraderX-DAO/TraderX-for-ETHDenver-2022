...
This directory has a sample Dapp to interact with project smart contracts, built using
React.
...
Feel free to reach us through this repository.

Also you can [follow us on Twitter](https://twitter.com/<To_Be_Added>).
